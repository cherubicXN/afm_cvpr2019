...
def afm_transform_gpu(np.ndarray[np.float32_t, ndim=2] lines, 
    ...
    _AttractionFieldMap(n_lines, <const float*> lines.data,
                        height, width, <float*> afmap.data,
                        <int*> aflabel.data, device_id);
